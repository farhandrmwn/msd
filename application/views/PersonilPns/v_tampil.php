<?php $this->load->view('partials/header') ?>
 ...
 <div class="container-fluid mt--6">
      ...
      <h1 class="mb-0"> PERSONIL  PNS</h1>
         ...
         <form method="post" action="<?php echo base_url('PersonilPns/index')?>">
       <div class="col-md-12">
                <div class="container"> 
                <div class="row">  
                <div class="col-md-5">
        ...
        <div class="card-body">
            <a href="<?php echo base_url()?>/PersonilPns/tambah" class="btn btn-primary" role="button">Tambah Data</a>
                ...
                <table class="table table-bordered text-center mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                           <?php 
                              foreach ($personilpns as $a) {
                                $cek = $a->bulan;
                              } 
                                $s = substr($cek, -4,4);
                               ?>
                          <div class="row">
                         <a href="<?= base_url('PersonilPns/edit/'.$p->id) ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                         <form method="POST" action="<?php echo base_url('PersonilPns/hapusdata/'.$p->id)?>" >
