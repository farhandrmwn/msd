<?php $this->load->view('partials/header') ?>
 ...
 <div class="container-fluid mt--6">
      ...
      <h1 class="mb-0"> RUMAH DINAS POLRI</h1>
         ...
         <form method="post" action="<?php echo base_url('Rekap_Rumdin_Polri/index')?>">
       <div class="col-md-12">
                <div class="container"> 
                <div class="row">  
                <div class="col-md-5">
        ...
        <div class="card-body">
            <?php foreach($rdpolri as $p){ 
              $cek = $p->bulan;
            $s = substr($cek, -4,4);}?>
            <form method="POST" action="<?php echo base_url('Rekap_Rumdin_Polri/excel?$bulan='.$s.''); ?>">
                ...
                <table class="table table-bordered text-center mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $r->ket ?></td>
                      <td>
                        <a href="<?= base_url('Rekap_Rumdin_Polri/edit/'.$r->id) ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                        <a href="<?= base_url('Rekap_Rumdin_Polri/hapus/'.$r->id) ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Remove</a>
                     </td>
                    </tr>
                    <?php } ?>
                  </tbody>
